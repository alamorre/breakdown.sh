  ...
  return (
    <div className="flex min-h-screen flex-col bg-background text-foreground">
      <main className="flex flex-1">
        <section className="mx-auto flex w-full max-w-3xl flex-col justify-center px-6 py-16">
      ...
      <footer className="border-t px-6 py-5 text-sm text-muted-foreground">
        <div className="mx-auto flex w-full max-w-3xl flex-wrap gap-x-5 gap-y-2">
          <Link className="transition-colors hover:text-foreground" href="/privacy">
            Privacy
          </Link>
          <Link className="transition-colors hover:text-foreground" href="/terms-of-service">
            Terms
          </Link>
        </div>
      </footer>
