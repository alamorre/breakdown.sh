...
import { getAgentSetupSession } from '@/lib/breakdown-service/agent-setup-sessions';
...
export async function GET(
  ...
  try {
    ...
    return Response.json(await getAgentSetupSession(supabase, { sessionId }, originFor(request)));
  } catch (err) {
