...
export function getExternalConsoleOnboardingMetadata(origin: string) {
  return {
    ...
    endpoints: {
      ...
      codexDiagnosticsUrl: `${origin}/api/integrations/codex/diagnostics`,
    ...
    auth: {
      ...
      codexDiagnostics: 'optional-bearer-token',
      mcp: 'bearer-token',
    ...
    firstRun: {
      ...
      diagnosticsResultShape: ['ok', 'state', 'checks', 'toolSurface', 'scopes', 'setup'],
