...
export async function writeProvenanceInputs({
  ...
  const provenance = {
    ...
    statement:
      'These content-addressed inputs and subjects describe an optional local artifact build. They are not required for npm publication.',
    source: {
...
export async function writeReleaseManifest({
  ...
  const manifest = {
    ...
    publication_evidence: {
      state: 'not-required-for-npm-publication',
      workflow: '.github/workflows/local-stable-publication.yml',
    },
  };
