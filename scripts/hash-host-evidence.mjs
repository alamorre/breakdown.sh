...
import { hashHostEvidence } from './local-release/host-evidence.mjs';

export async function main(argv = process.argv) {
  const usage = 'Usage: hash-host-evidence.mjs --submission PATH';
  const result = await hashHostEvidence({
