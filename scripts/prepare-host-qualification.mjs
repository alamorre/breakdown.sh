...
import { writeHostQualificationTemplate } from './local-release/host-evidence.mjs';

export async function main(argv = process.argv) {
  const usage = 'Usage: prepare-host-qualification.mjs --candidate PATH --output PATH';
  const result = await writeHostQualificationTemplate({
