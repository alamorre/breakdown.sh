...
- `local/contracts/conformance/hosts/fixtures/agent-review-rubric.json` — SHA-256 `a5746f3bcceb757c4e176984c854eebb0b819ddc61e2fe88f833f57c9d10a057`
- `local/contracts/conformance/hosts/fixtures/guided-journey.json` — SHA-256 `c11571dca17ad6e7e5ae72828289d181ee19ba84660b7794029597832b7c9a12`
- `local/contracts/conformance/hosts/fixtures/qualification-authorization.json` — SHA-256 `cf0b3ea27c415369dd522391b4ce6afecd5598056d3f006948cb745709ac09c9`
- `local/contracts/conformance/traceability/host.json` — SHA-256 `3cf648a8b09eefdba368c8d05b4cad3b3332cd36c9b917422f8dbff19b271efa`
- `local/contracts/schemas/breakdown.guided-host-authorization.v1.schema.json` — SHA-256 `137b6cb2c65fee81f8d4e1bf7e2807abd267da8bdb14ed90fb8e0f772a94aa6f`
- `local/contracts/schemas/breakdown.guided-host-evidence.v2.schema.json` — SHA-256 `17af2372a6356cb1ba30321f45f666623cb6bed651553022e4ef920c22e8f1ab`
...
- `local/skills/setup-breakdown/assets/skill-pack-manifest.json` — SHA-256 `a7790a75ed7653285f99beeb22b0338b0a7b099b8335a0161316beb7458decbb`


## Supported Host rows

| Exact row | Passing immutable evidence |
| --- | --- |
