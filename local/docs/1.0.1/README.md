...
[the immutable breakdown-local-v1.0.1 release](https://github.com/alamorre/breakdown.sh/releases/tag/breakdown-local-v1.0.1) are the only authority for exact
