...
distributed as part of this skill.

The setup guidance references the external `skills@1.5.20` installer. That installer is not
incorporated into or distributed with this skill.
